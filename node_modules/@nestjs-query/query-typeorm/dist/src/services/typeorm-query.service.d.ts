 ...
 * ```
 */
export declare class TypeOrmQueryService<Entity> extends RelationQueryService<Entity> implements QueryService<Entity> {
     ...
     */
    updateOne<U extends DeepPartial<Entity>>(id: number | string, update: U, opts?: UpdateOneOptions<Entity>): Promise<Entity>;
    /**
     ...
     */
    updateMany<U extends DeepPartial<Entity>>(update: U, filter: Filter<Entity>): Promise<UpdateManyResponse>;
    /**
