...
exports.classMetadataDecorator = (key) => {
...
class MapReflector extends Reflector {
    ...
    get(DTOClass, key, includeParents = false) {
        var _a;
        return (_a = this.getMetadata(DTOClass, includeParents)) === null || _a === void 0 ? void 0 : _a.get(key);
    }
    has(DTOClass, key) {
        var _a, _b;
