...
export declare class AssemblerQueryService<DTO, Entity> implements QueryService<DTO> {
    readonly assembler: Assembler<DTO, Entity>;
    readonly queryService: QueryService<Entity>;
    constructor(assembler: Assembler<DTO, Entity>, queryService: QueryService<Entity>);
