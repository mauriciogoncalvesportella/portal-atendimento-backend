...
const getEscapedControlChar = (c) => {
    var _a;
    return (_a = ESCAPED_CONTROL_CHARS.get(c)) !== null && _a !== void 0 ? _a : `\\x${c.charCodeAt(0).toString(16).padStart(2, `0`)}`;
};
const getEscapedDblChar = (match) => {
    var _a;
    return (_a = ESCAPED_DBL_CHARS.get(match)) !== null && _a !== void 0 ? _a : `"$'${getEscapedControlChar(match)}'"`;
};
