...
import {
  ...
  ChangeSituacaoDTO,
  TicketFilterDTO,
  AcaoAnexoDownloadDTO,
  allUsersFromTicketDTO,
  SituacaoAddDTO,
  SituacaoUpdateDTO,
  UrgenciaUpdateDTO,
  UrgenciaAddDTO,
...
export class TicketController {
  ...
  async addTicket(@Req() req, @Body() data: TicketAddDTO) {
    ...
    const ret = await this.ticketService.addTicket(
      data,
      null,
      req.user,
      null,
  ...
  downloadFile(
    @Req() req: Request,
    @Res() res: Response,
    @Body() data: AcaoAnexoDownloadDTO
  ) {
    const filePath = path.resolve(
      `./anexos/${data.cdticket}/${data.cdacao}/${data.nmfile}`
    );
  ...
  async situacaoUpdate(
    @Body(new ParseArrayPipe({ items: SituacaoUpdateDTO }))
    data: SituacaoUpdateDTO[]
  ): Promise<void> {
  ...
  @Post("situacao/add")
  async situacaoAdd(
    @Body(new ParseArrayPipe({ items: SituacaoAddDTO })) data: SituacaoAddDTO[]
  ): Promise<void> {
  ...
  async urgenciaUpdate(
    @Body(new ParseArrayPipe({ items: UrgenciaUpdateDTO }))
    data: UrgenciaUpdateDTO[]
  ): Promise<void> {
  ...
  @Post("urgencia/add")
  async urgenciaAdd(
    @Body(new ParseArrayPipe({ items: UrgenciaAddDTO })) data: UrgenciaAddDTO[]
  ): Promise<void> {
